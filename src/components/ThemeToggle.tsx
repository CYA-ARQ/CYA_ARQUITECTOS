...
export function ThemeToggle({ isDark, onToggle }: ThemeToggleProps) {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.96 }}
      className={cn(
        "fixed right-4 top-4 z-[80] flex h-11 w-11 items-center justify-center rounded-full border shadow-sm backdrop-blur-2xl transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 md:right-6 md:top-6",
        isDark
